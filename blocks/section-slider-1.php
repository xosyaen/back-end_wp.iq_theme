        ...
        <?php while( have_rows('section-slider_slide')): the_row(); 
          ...
          <div class="sliders_work_results__slide">
            <div class="sliders_work_results__row row">
              <div class="sliders_work_results__col col-lg-6 col-md-7 col-sm-12 col-xs-12">
                <div class="sliders_work_results__row row">
                  <div class="sliders_work_results__col col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="sliders_work_results__col col-lg-6 col-md-5 col-sm-12 col-xs-12">
                <div class="sliders_work_results__block">
                  <div class="sliders_work_results__text text">
                    <?=$content_3?>
                  </div>
